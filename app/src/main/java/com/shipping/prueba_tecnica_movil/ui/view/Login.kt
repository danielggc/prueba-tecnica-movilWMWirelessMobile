...
import com.shipping.prueba_tecnica_movil.databinding.LoginBinding
import com.shipping.prueba_tecnica_movil.ui.viewmodel.UserViewModel
import com.shipping.prueba_tecnica_movil.ui.viewmodel.ViewModelFactory
    ...
    private fun observeUsernameValidation() {
        userVM.usernameValidation.observe(viewLifecycleOwner, Observer { newValue ->
            when (newValue) {
                ...
                LoginResult.SHORT_USERNAME.value -> setUserNameError(getString((R.string.username_error_short_user_name)))
